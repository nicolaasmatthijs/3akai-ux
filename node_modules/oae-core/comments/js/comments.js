...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setUpPushNotifications = function() {
            oae.api.push.subscribe(contextProfile.id, 'message', contextProfile.signature, function(activity) {
                // A new comment has been added
                if (activity['oae:activityType'] === 'content-comment' || activity['oae:activityType'] === 'discussion-message') {
                    // TODO
                    var comments = activity.object['oae:collection'] ? activity.object['oae:collection'] : [activity.object];
                    _.each(comments, function(comment) {
                        // Only do something with this comment if it isn't already in the comment stream
                        // The comment is a reply to a comment
                        // TODO
                        if (comment.inReplyTo) {

                        // The comment is a new top level comment
                        } else {
