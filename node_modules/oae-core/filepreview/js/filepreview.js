...
define(['require', 'jquery', 'oae.core'], function(require, $, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Subscribe to content push notifications. When a notifications comes in that indicates that preview
         * processing has finished, the content preview is re-rendered to show the newly generated preview.
         */
        var setUpPushNotifications = function() {
            oae.api.push.subscribe(widgetData.id, 'activity', widgetData.signature, function(activity) {
                if (activity['oae:activityType'] === 'previews-finished') {
                    // Retrieve the updated content profile
