...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        ...
        <!-- LOGO -->
        <div id="topnavigation-institutional-logo-container" class="hidden-xs col-sm-2 text-center"><!-- --></div>
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="col-xs-6 col-sm-5 text-right">
            <!-- SEARCH FORM -->
