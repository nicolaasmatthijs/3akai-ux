...
define(['jquery', 'oae.core', '/node_modules/oae-core/contentpreview/lib/document-viewer/assets/viewer.js'], function($, oae, DV) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderImagePreview = function() {
            oae.api.util.template().render($('#contentpreview-image-template', $rootel), widgetData, $('#contentpreview-container-content', $rootel));
        };
        ...
        var renderLinkPreview = function() {
            oae.api.util.template().render($('#contentpreview-html-template', $rootel), widgetData, $('#contentpreview-container-content', $rootel));
        };
        ...
        var renderDocumentPreview = function() {
            ...
            DV.load(doc, {
                'container': '#' + uid + ' #contentpreview-container-content',
                'width': '100%',
                'height': 700,
                'sidebar': false,
                'text': false
        ...
        var renderDefault = function() {
            oae.api.util.template().render($('#contentpreview-default-template', $rootel), widgetData, $('#contentpreview-container-content', $rootel));
        };
