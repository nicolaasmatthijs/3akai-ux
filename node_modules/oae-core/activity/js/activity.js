...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var setUpPushNotifications = function() {
            // TODO
            oae.api.push.subscribe(widgetData.context.id, 'activity', widgetData.context.signature, function(activity) {

                // Aggregate content creation / content sharing / link adding / link sharing

                // Prepend
                // with animation if visible
                // without animation if not visible
