        ...
        {macro renderSingleBox(entity)}
            <li>
                <div class="oae-tile">
                    ...
                    <div>
                        <i class="icon-oae-${entity['oae:visibility']} pull-right"></i>
                        <h3 class="oae-threedots">
                            <a href="${entity.url}">${entity.displayName|encodeForHTML}</a>
                        </h3>
                        {if entity.objectType === 'content'}
                            <small class="oae-threedots">${oae.api.content.getMimeType(entity).description}</small>
                    ...
                    <div class="oae-tile">
                        ...
                        <div>
                            ...
                            {if content.objectType === 'content'}
                                <small class="oae-threedots">${oae.api.content.getMimeType(content).description}</small>
