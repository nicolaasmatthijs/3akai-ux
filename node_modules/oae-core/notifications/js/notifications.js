...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid) {
        ...
        /**
         * Subscribe to notidication push notifications, allowing for new notifications to be prepended to the
         * notification stream straight away
         */
        var setUpPushNotifications = function() {
            oae.api.push.subscribe(oae.data.me.id, 'notification', oae.data.me.signature, function(activity) {
                // Prepend the new notification to the notification stream
                infinityScroll.prependItems({'items': [activity]});
                flagUnread();
                // Mark the notification as read when the notification stream is already showing
