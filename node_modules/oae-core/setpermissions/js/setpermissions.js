...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        // Variable that keeps track of the number of items that are staged to be added
        var count = null;
        ...
        var setUpSetPermissionsModal = function() {
            // Render the visibility options with the default visibility selected
            oae.api.util.template().render('#setpermissions-visibility-template', widgetData, '#setpermissions-visibility-container');

            // Bind the event that will be used to indicate how many items are staged to be added
            $(document).on('oae.setpermissions.init.' + uid, function(ev, data) {
                count = data.count;
                // TODO
                setUpAutoSuggest(savePermissionsChange);
                // Immediately return a summary for the staged items
