...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid) {
        ...
        // Generate a widget ID for the instance of the `setpermissions` widget that this widget will be using.
        // This widget ID will be used in the event communication between this widget and the `setpermissions` widget.
         ...
         * TODO
         */
        var getInitialPermissionsSummary = function() {
            if (selectedFiles.length) {
                $(document).trigger('oae.setpermissions.init.' + setPermissionsId, {'count': selectedFiles.length});
            }
        };
        ...
        var setUpSetPermissions = function() {
            ...
            oae.api.widget.insertWidget('setpermissions', setPermissionsId, $('#upload-permissions-container', $rootel), false, {
                'type': 'file',
