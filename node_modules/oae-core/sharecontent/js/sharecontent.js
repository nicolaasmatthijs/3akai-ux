...
define(['jquery', 'oae.core', 'jquery.autosuggest'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         * TODO
         */
        var setUpAutosuggest = function($currentRootel) {
            $rootel = $currentRootel;
            oae.api.util.autoSuggest($('#sharecontent-autosuggest', $rootel), ['user', 'group']);
        };
        ...
        var initShare = function() {
            $(document).on('click', '.oae-trigger-sharecontent', function() {
                // Trigger the share clickover
                oae.api.util.clickover($(this), $('.sharecontent-widget'), {
                    'onShown': setUpAutosuggest
                });
            });
        };
